...
const MainPanel = () => {
  ...
  const handleSubmit = () => {
    if (!selectedLocker) {
      ...
      Axios.post(`${process.env.REACT_APP_API}/cabinets`, { code: inputValue })
        .then((response) => {
 ...
 .then((response)=>{
  ...
  Axios.put(`${process.env.REACT_APP_API}/updateForDelivery`, { code: inputValue })
      .then((response) => {
    ...
    Axios.put(`${process.env.REACT_APP_API}/updateForPickup`, { code: inputValue })
      .then((response) => {
